  ...
  return (
    <>
      <Box mt={'7rem'}>
        ...
        <Text fontSize="lg" fontWeight="400" mb={12} textAlign="center" color={'gray.500'}>
          What our customers are saying about us and our products.
        </Text>
      </Box>
      <Container maxW="2xl" p={5} mb={'4rem'}>
        <VStack spacing={3}>
          <Icon
            as={FaQuoteRight}
            w={8}
